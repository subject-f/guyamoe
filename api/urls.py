...
urlpatterns = [
    ...
    re_path(r'^nh_image/(?P<media_id>[\d]{1,9})/(?P<page>[\w.]+)', views.get_nh_image, name='api-nh_image_proxy'),
    re_path(r'^md_image/(?P<server>[\w.]+)/(?P<data_hash>[\w]+)/(?P<page>[\w.]+)', views.get_md_image, name='api-md_image_proxy'),
