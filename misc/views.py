...
def content(request, page_url):
    ...
    return render(request, 'misc/misc.html', {'content': page.content, 'template': 'misc_pages_list'})
...
def misc_pages(request):
    ...
    return render(request, 'misc/misc_pages.html', {'pages': pages, 'template': 'misc_page'})