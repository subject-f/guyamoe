...
urlpatterns = [
    ...
    re_path(r'^manga/(?P<md_series_id>[\d]{1,9})/$', views.md_series, name='site-md-series'),
    re_path(r'^manga/(?P<md_series_id>[\d]{1,9})/([\w-]+)/$', views.md_series, name='site-md-series'),
    ...
    re_path(r'^g/(?P<nh_series_id>[\d]{1,9})/$', views.nh_series, name='site-nd-series'),
    re_path(r'^g/(?P<nh_series_id>[\d]{1,9})/(?P<page>[\d]{1,9})/$', views.nh_series, name='site-nd-chapter'),
    re_path(r'^fs/(?P<raw_url>[\w\d\/:.-]+)', views.fs_gateway, name='site-fs-gateway'),
